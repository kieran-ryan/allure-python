...
from allure_commons.types import LabelType, LinkType, AttachmentType, ParameterMode
...
class ExecutableItem:
    ...
    statusDetails: StatusDetails = attrib(default=None)
    stage: Stage = attrib(default=None)
    description: str | None = attrib(default=None)
    descriptionHtml: str | None = attrib(default=None)
